...
void displayAllEmployees()
{
    ...
    cout << "===============================================================" << endl;
    cout << "Emp ID  | Name                          | Basic Salary" << endl;
    cout << "--------+-------------------------------+--------------" << endl;
...
void deleteEmployeeRecord()
{
    ...
    {
        cout << "Error: Could not open 'employee.dat' file!" << endl;
        cout << "The file may not exist. Please create employee records first." << endl;
        return;
    }
    ...
    {
        cout << "Error: Invalid Employee ID! Please enter a positive integer." << endl;
        cin.clear();
        cin.ignore(10000, '\n');
        fclose(originalFile);
        return;
    ...
    // Step 2: Create a temporary file in write binary mode
    FILE *tempFile = fopen("temp.dat", "wb");
    if (tempFile == NULL)
    {
        cout << "Error: Could not create temporary file 'temp.dat'!" << endl;
        cout << "Please check write permissions in the directory." << endl;
        fclose(originalFile);
        return;
    }
