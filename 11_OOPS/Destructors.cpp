/*
 * Destructors & Object Lifetime in C++
 * 
 * This program demonstrates:
 * - Destructor syntax and automatic invocation
...
// DynamicArray class with enhanced destructor logging
class DynamicArray {
private:
    int* arr;
    int size;
    int id;  // Object identifier for tracking
    static int objectCount;  // Track total objects created
...
public:
    ...
    // Destructor - Logs when object is destroyed
    ~DynamicArray() {
...
// ============================================================================
// Function 1: Demonstrate stack-allocated array destruction order
// ============================================================================
void demoStackArrayDestruction() {
    cout << "\n=== Demo 1: Stack-Allocated Array of Objects ===" << endl;
    cout << "Creating array of 3 DynamicArray objects...\n" << endl;
    
    // Create array of 3 DynamicArray objects on the stack
    // Constructors are called in order: arr[0], arr[1], arr[2]
    DynamicArray arr[3];
