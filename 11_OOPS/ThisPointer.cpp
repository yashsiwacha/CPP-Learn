...
int main() {
    ...
    // Display dimensions of Box1 with proper formatting
    cout << "\n=== Dimensions of Box1 ===" << endl;
    cout << "Length : " << b1.getLength() << endl;
    cout << "Width  : " << b1.getWidth() << endl;
    cout << "Height : " << b1.getHeight() << endl;
    cout << "Volume : " << b1.calculateVolume() << " cubic units" << endl;

    // Display dimensions of Box2 with proper formatting
    cout << "\n=== Dimensions of Box2 ===" << endl;
    cout << "Length : " << b2.getLength() << endl;
    cout << "Width  : " << b2.getWidth() << endl;
    cout << "Height : " << b2.getHeight() << endl;
    cout << "Volume : " << b2.calculateVolume() << " cubic units" << endl;

    // Compare volumes and display result
    cout << "\n=== COMPARISON RESULT ===" << endl;
    const Box& largerBox = b1.compareVolume(b2);
    cout << "Box with greater volume is: " << largerBox.getName() << endl;
