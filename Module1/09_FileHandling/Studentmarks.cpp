...
// Search for student by roll number and update their marks
// Uses file seeking to directly modify the record in place
void searchAndUpdateMarks()
{
    // Open file in read+write binary mode to allow modifications
