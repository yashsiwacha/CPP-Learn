...
public:
    DynamicArray()
    {
        ...
        cout << "Constructor called for DynamicArray[" << id << "] - Created array of size " << size << "\n";
    }
    ...
    DynamicArray(int s)
    {
        ...
        cout << "Parameterized Constructor called for DynamicArray[" << id << "] - Created array of size " << size << "\n";
    }

    ~DynamicArray()
    {
        cout << "Destructor called for DynamicArray[" << id << "] - Freeing memory for array of size " << size << "\n";
        delete[] arr;
        arr = nullptr;
    }
