...
public:
    Element() : value(0)
    {
        cout << "Constructor called for Element at " << this << "\n";
    }

    Element(int val) : value(val)
    {
        cout << "Constructor called for Element with value " << val << "\n";
    }

    ~Element()
    {
        cout << "Destructor called for Element at " << this << " with value " << value << "\n";
    }
